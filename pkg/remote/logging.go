...
func (p *ErrorLoggingServer) Export(ctx context.Context) (config []byte, err error) {
	defer func() {
		if err != nil {
			...
			p.logger.Error("request error", zap.String("method", "Export"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) ListServices(ctx context.Context, maybeNamespace string) (_ []v6.ControllerStatus, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "ListServices"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) ListServicesWithOptions(ctx context.Context, opts v11.ListServicesOptions) (_ []v6.ControllerStatus, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "ListServicesWithOptions"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) ListImages(ctx context.Context, spec update.ResourceSpec) (_ []v6.ImageStatus, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "ListImages"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) ListImagesWithOptions(ctx context.Context, opts v10.ListImagesOptions) (_ []v6.ImageStatus, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "ListImagesWithOptions"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) JobStatus(ctx context.Context, jobID job.ID) (_ job.Status, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "JobStatus"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) SyncStatus(ctx context.Context, ref string) (_ []string, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "SyncStatus"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) UpdateManifests(ctx context.Context, u update.Spec) (_ job.ID, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "UpdateManifests"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) GitRepoConfig(ctx context.Context, regenerate bool) (_ v6.GitConfig, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "GitRepoConfig"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) Ping(ctx context.Context) (err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "Ping"), zap.Error(err))
		}
	}()
...
func (p *ErrorLoggingServer) Version(ctx context.Context) (v string, err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "Version"), zap.Error(err), zap.String("version", v))
		}
	}()
...
func (p *ErrorLoggingServer) NotifyChange(ctx context.Context, change v9.Change) (err error) {
	defer func() {
		if err != nil {
			p.logger.Error("request error", zap.String("method", "NotifyChange"), zap.Error(err))
		}
	}()
